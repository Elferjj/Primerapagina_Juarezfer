...
class Producto(models.Model):
    ...
    imagen = models.ImageField(upload_to='productos/', blank=True, null=True) # Para la imagen del producto
    fecha_publicacion = models.DateTimeField(auto_now_add=True)
    autor = models.ForeignKey(User, on_delete=models.CASCADE, related_name='productos_publicados') # ¡Nuevo campo!

    def __str__(self):
        return self.nombre

    def get_absolute_url(self):
        # Esta función es útil para redireccionar después de crear/actualizar un producto
